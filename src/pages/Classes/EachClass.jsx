    ...
    <div className='paddingcontroller '>
        {
          DispayEach.map((detail,index)=>(
            <div key={index}>
              ...
              <p className='text-3xl mt-8 '> {detail?.totalEnrolled} <span className='text-2xl font-bold'>already enrolled  </span> </p>
              </div>

              <div className='w-1/2'>
              <img src={detail?.image} alt="Detail page image" className='rounded-md shadow-2xl' />
              </div>
              </div>
              ...
              <div className='w-1/2 border-r-2 border-blue-500'>
                <h1 className='text-7xl text-blue-500 font-bold mt-16 text-center '>About</h1>
                {
                  <div>
